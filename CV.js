  ...
  work: [
    {
      ...
      projects: [
        {
          short: 'backend application for the of bonuses, discounts and cashbacks system',
          role: 'lead, backend',
          tech: 'php',
          tasks: [
        ...
        {
          short: 'golang microservice for b2b electronics portal (collecting, caching, changes checking and data sending (to the side system))',
          role: 'backend',
          tech: 'golang, redis',
          tasks: [
            'application architecture design',
        ...
        {
          short: 'full-stack web back-office application for the iVolga 2.0 youth forum',
